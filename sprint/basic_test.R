library(stm)
deter <- stm(poliblog5k.docs, poliblog5k.voc, K=5, prevalence=~rating, data=poliblog5k.meta, max.em.its = 2, control=list(method="BFGS", order_sigma=TRUE, order_beta=TRUE))
