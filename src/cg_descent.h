...
typedef struct cg_com_struct /* common variables */
{
    ...
    double   (*cg_value) (double *, INT, INT, double*, double*, double*, double*) ; /* f = cg_value (x, n) */
    void      (*cg_grad) (double *, double *, INT, INT, double*, double*, double*, double*) ; /* cg_grad (g, x, n) */
    double (*cg_valgrad) (double *, double *, INT, INT, double*, double*, double*, double*) ; /* f = cg_valgrad (g,x,n)*/
