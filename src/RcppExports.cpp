...
RcppExport SEXP _stm_n_mat_sumcpp(SEXP sum_SEXP, SEXP c_SEXP, SEXP input_SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(n_mat_sumcpp(sum_, c_, input_));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_stm_n_mat_sumcpp", (DL_FUNC) &_stm_n_mat_sumcpp, 3},
    {NULL, NULL, 0}
};
